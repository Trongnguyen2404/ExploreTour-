...
import com.example.loginpage.ui.components.ReviewSection
    ...
    LazyColumn(
        ...
        item {
            Column(
                ...
                Text(
                    text = "CHÀO MỪNG ĐẾN", // Có thể đổi tiêu đề chung
        ...
        item {
            ...
            Column(modifier = Modifier.fillParentMaxWidth()) {
                ...
                InfoRow(
                    ...
                    text = "Số chỗ còn: ${tourDetail.availableSlots}"
                )
...
//                )
                ...
                Text("Không có mô tả.", style = MaterialTheme.typography.bodyMedium)
            }
        }
        ...
        item { // item này chứa toàn bộ khu vực đánh giá
            ...
            ReviewSection(
                ...
                // --- SỬA ĐỔI ---
                // Truyền null, ReviewSection sẽ hiển thị ảnh placeholder mặc định
                currentUserImageUrl = null,
                onLoadMore = { viewModel.loadMoreReviews() },
                onAddReview = { rating, comment ->
                    // Vẫn giữ lại logic gọi ViewModel để thêm review
